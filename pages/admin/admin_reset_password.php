    ...
    <div class="container">
        <div class="left">
            ...
            <ul class="nav">
                ...
                <li><a href="admin_reset_password.php" class="active"><i class='bx bx-lock-alt' ></i>Password</a></li>
            </ul>
        </div>
        ...
        <div class="right">
            ...
            <!-- Reset password -->
            <form method="post" action="../../backend/admin_reset_password.php" onsubmit="return validateResetPassword()">
